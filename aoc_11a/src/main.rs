...
fn prepare_aoc_11a_input(filename: &str) -> Result<Grid2d, std::io::Error> {
...
fn solve_aoc_11a(input: &Grid2d) -> usize {
    //println!("{:?}", input);
...
fn main() -> Result<(), std::io::Error> {
    let input = prepare_aoc_11a_input("input/input.txt")?;
    let result = solve_aoc_11a(&input);
...
mod tests {
    ...
    #[test]
    fn test_aoc_11a() {
        let input = prepare_aoc_11a_input("input/test.txt").unwrap();
        let result = solve_aoc_11a(&input);
